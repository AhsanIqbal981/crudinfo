...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `info` (`name`, `email`, `num`, `pass`) VALUES ( '$name', '$email', '$mobile', '$password')";
...
<body>
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <button name="submit" type="submit" class="btn btn-primary"> <a href="display.php" class="text-light">Display data</a></button>
        </form>
    </div>
</body>
